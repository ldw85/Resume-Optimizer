...
const HeroReportWrapper = () => {
  ...
  const adjustIframeHeight = () => {
    if (iframeRef.current) {
      ...
      setTimeout(() => {
        ...
        console.log('Calculated Hero iframe scrollHeight:', newHeight); // Log the calculated height
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh' }}> {/* Ensure parent div is tall enough */}
      <iframe
        ref={iframeRef}
        src="/blog/The-2025-Guide-to-AI-Resume-Optimizers.html"
        title="The 2025 Guide to AI Resume Optimizers"
        width="100%"
        frameBorder="0"
        scrolling="no"
...
export default HeroReportWrapper;
